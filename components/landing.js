...
export default function Landing () {
    return (
        <div id="home" className="bg-stone-900 text-white h-screen w-full items-center flex flex-col justify-center">
            <svg data-aos="zoom-y-out" data-aos-delay="2000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1240 300" className="absolute bottom-0">
            ...
            <svg data-aos="zoom-y-out" data-aos-delay="1900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 270" className="absolute bottom-0">
            ...
            <div className="font-mono">
                ...
                <br/>
                <nav className="md:text-xl float-left flex flex-col">
                <button data-aos="fade-right" data-aos-delay="2100" 
                        class="hover:text-xl md:hover:text-2xl text-left">
                    About
                </button>
                <button data-aos="fade-right" data-aos-delay="2200" 
                        class="hover:text-xl md:hover:text-2xl text-left">
                    Blog
                </button>
                <button data-aos="fade-right" data-aos-delay="2300"
                        class="hover:text-xl md:hover:text-2xl text-left">
                    Projects
                </button>
                <button data-aos="fade-right" data-aos-delay="2400"
                        class="hover:text-xl md:hover:text-2xl text-left">
                    Contact
                </button>
                </nav>       
