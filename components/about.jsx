  ...
  return (
    ...
    <div className="flex flex-col md:flex-row-reverse">
      ...
      <div className="text-gray-800 text-center font-mono px-6 md:text-left">
              ...
              <p className="my-5 text-lg lg:pr-24">Currently, I&apos;&apos;e been working on Full-stack Web Development, Generative AI, and Machine Learning projects. I have also worked with Blockchain Technology.</p>
